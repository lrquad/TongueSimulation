...
class LoboneoHookeanIsotropicMaterial:public LoboIsotropicHyperelasticWithCompressionResistance
{
public:
	LoboneoHookeanIsotropicMaterial(TetVolumetricMesh* tetmesh, int enableCompressionResistance = 0, double compressionResistance = 0.0);
	~LoboneoHookeanIsotropicMaterial();
