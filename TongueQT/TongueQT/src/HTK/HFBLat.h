...
typedef struct {
  ...
  BooleanC MPE;  /* currently doing MPE/MWE, this may change from call to call
  ...
  UPDSet uFlags;
  BooleanC firstTime ;     /* Flag used to enable creation of ot */
  ...
  BooleanC InUse; /* FALSE if stacks are cleared and lattices empty. */
...
void InitialiseFBInfo(FBLatInfo *fbInfo, HMMSet *hset, UPDSet uset, BooleanC TwoDataFiles); 
