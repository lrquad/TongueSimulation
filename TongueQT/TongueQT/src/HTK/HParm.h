...
typedef struct {
   BooleanC eSep;         /* Energy is in separate stream */
...
typedef struct {
   ...
   BooleanC saveCompressed;    /* Save in compressed format */
   BooleanC saveWithCRC;       /* Save with CRC check added */
   BooleanC spDetParmsSet;     /* Parameters set for sp/sil detector */
...
BooleanC HasEnergy(ParmKind kind);
BooleanC HasDelta(ParmKind kind);
BooleanC HasNulle(ParmKind kind);
BooleanC HasAccs(ParmKind kind);
BooleanC HasThird(ParmKind kind);
BooleanC HasCompx(ParmKind kind);
BooleanC HasCrcc(ParmKind kind);
BooleanC HasZerom(ParmKind kind);
BooleanC HasZeroc(ParmKind kind);
BooleanC HasVQ(ParmKind kind);
/* 
