...
public:
  ...
  */
  ...
  virtual bool getCollidingTriangleList(std::vector<int> &trilist1, std::vector<int> &trilist2) = 0;
  ...
  */
  ...
  virtual bool getCollisionPoint(float p[3], int triangle1, int traingel2, bool ModelSpace) = 0;
