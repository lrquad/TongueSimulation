...
public:
  ...
  bool getCollidingTriangleList(std::vector<int> &trilist1, std::vector<int> &trilist2);
  bool getCollisionPoint(float p[3], bool ModelSpace);
  bool getCollisionPoint(float p[3], int triangle1, int traingel2, bool ModelSpace);
  ...
  */
  ...
  std::vector<int>			 m_trilist1;
  std::vector<int>			 m_trilist2;
  std::vector<Triangle>		 m_triangleList1;
  std::vector<Triangle>		 m_triangleList2;
